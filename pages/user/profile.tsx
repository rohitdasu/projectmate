        ...
        <div className="flex w-full flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[75%]">
            <Typography
              as="p"
              fontWeight="semibold"
              className="mt-3 font-medium text-gray-100 sm:mt-4 sm:text-lg lg:mt-0"
            >
              Your Projects
            </Typography>
            <ul className="grid auto-rows-auto gap-5 pt-5 text-[#B7C2D1] sm:grid md:grid-cols-1 lg:grid-cols-2">
              {projects &&
                projects.length > 0 &&
                projects.map(
                  (item: {
            ...
            {projects && projects.length === 0 && (
              <div className="flex h-96 w-full items-center justify-center rounded-md border border-gray-700">
