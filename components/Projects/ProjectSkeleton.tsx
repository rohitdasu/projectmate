      ...
      <div className="flex flex-col gap-5 p-4 pt-2">
        <div className="flex w-full items-center">
          <div className="flex-1 flex-col gap-2">
            ...
            <div className="mt-2 h-2 w-36 rounded-full bg-gray-200 dark:bg-gray-700" />
          </div>
          <div className="flex flex-1 justify-end gap-2">
            <div className="mt-2 h-7 w-16 rounded-md bg-gray-200 dark:bg-gray-700" />
            <div className="mt-2 h-7 w-7 rounded-md bg-gray-200 dark:bg-gray-700" />
          </div>
        </div>
        <div className="mt-4">
