...
export const SharedLayout: FC<SharedLayoutProps> = ({
  ...
  return (
    <div className="flex min-h-screen w-full flex-col">
      ...
      {topBar && (
        <nav
          className={`sticky z-10 block overflow-hidden border-b transition-all lg:hidden ${
      ...
      {bottomBar && (
        <div className="sticky bottom-0 z-10 block h-14 w-full border-t bg-transparent lg:hidden">
          <BottomBar />
        </div>
      )}
    </div>
